...
function formatResult(imageUrl, message) {    
    return '<!DOCTYPE html><html><head><title>New Card</title><meta charset="UTF-8"/>' 
            ...
            + '<br><br><div><input class="emailbar" name="email" placeholder="Recipient Email Address"><br><br><button id="buybutton" class="buybutton" type="submit">Send!</button><p class="attribution">'
